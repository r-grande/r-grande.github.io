...
\recipient{School of Mathematics}{University of Edinburgh}
\date{\today}
...
A CV and a research statement are included with this application. Moreover, I have asked the following professors to submit a letter of recommendation:
\begin{list}{$\bullet$}{}
