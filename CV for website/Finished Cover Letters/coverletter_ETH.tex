...
\recipient{Department of Mathematics}{ETH Z\"urich}
\date{\today}
...
A CV, a detailed research statement, a teaching statement and a list of publications are included with this application. Moreover, I have asked the following professors to submit a letter of recommendation:
\begin{list}{$\bullet$}{}
