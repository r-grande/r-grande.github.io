...
\recipient{Mathematical problems in fluid dynamics}{Mathematical Sciences Research Institute}
\date{\today}
...
A CV and a detailed research statement are included with this application. Moreover, I have asked the following professors to submit a letter of recommendation:
\begin{list}{$\bullet$}{}
