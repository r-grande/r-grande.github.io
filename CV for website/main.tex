...
\address{D\'ept. de math\'ematiques et applications, Bureau C16}{\'Ecole Normale Sup\'erieure, Paris 75005}
...
\cvitem{}{Nonlinear PDEs, Kinetic theory, Harmonic Analysis}
\cvitem{}{Probability, Stochastic Processes}
...
\cvitem{2021 - Currently}{\textbf{Postdoctoral Researcher}, \emph{\'Ecole Normale Sup\'erieure, Paris}}
...
\cvitem{Summer 2021}{\textbf{REU co-mentor} (with Z. Hani), University of Michigan}
...
\cvitem{1.}{R. Grande, Z. Hani, \emph{Derivation of the Wave Kinetic Equation for the Stochastic NLS Equation}, in preparation (2022)}
\cvitem{2.}{M. A. Garrido, R. Grande, K. M. Kurianski, G. Staffilani, \emph{Large deviations principle for the cubic NLS equation}, to appear on Comm. on Pure and Applied Mathematics (2022), preprint available at \url{https://arxiv.org/abs/2110.15748}}
\cvitem{3.}{R. Grande, K. M. Kurianski, G. Staffilani, \emph{On the nonlinear Dysthe equation}, Nonlinear Analysis 207, 112292 (2021)}
\cvitem{4.}{R. Grande, \emph{Continuum limit for discrete NLS with memory effect}, submitted, preprint available at \url{arxiv.org/abs/1910.05681}}
\cvitem{5.}{R. Grande, \emph{Space-time fractional Nonlinear Schr\"odinger equation}, SIAM J.$\!$ Math.$\!$ Anal (2019), 51(5), 4172-4212}
\cvitem{6.}{R. Grande, I. Kov\'acs, K. Kutnar, A. Malni\v{c}, L. Mart\'inez, D. Maru\v{s}i\v{c},  \emph{Equisizable partial sum families}, Journal of Algebraic Combinatorics 51, 273-296 (2020)}
\cvitem{7.}{M. Conder, R. Grande, \emph{On embeddings of circulant graphs}, Electronic Journal of Combinatorics 22 (2015), $\#$ P2.28}
...
\hspace{3.2cm} {\large Invited speaker}

\vspace{0.25cm}

\cvitem{Sept 2022}{\textbf{Trials in wave turbulence: from random waves to kinetic equations}, GSSI}
\cvitem{June 2022}{\textbf{Mini-course about Large Deviations et PDEs (4h)}, SISSA Trieste}
...
\hspace{3.2cm} {\large Participant}
...
\cvitemwithcomment{}{\textbf{Italian}, Fluent}{}
