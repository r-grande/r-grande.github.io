...
\cvitem{}{\'Equations dispersives non lin\'eaires, th\'eorie cin\'etique, analyse harmonique}
\cvitem{}{Probabilit\'es, processus stochastiques}
...
\cvitem{}{R. Grande, Z. Hani, \emph{Derivation of the Wave Kinetic Equation for the Stochastic NLS Equation}, en cours de r\'edaction (2022)}
...
\cvitem{\textbf{1.}}{M. A. Garrido, R. Grande, K. M. Kurianski, G. Staffilani, \emph{Large deviations principle for the cubic NLS equation}, prochainement publié dans Communications on Pure and Applied Mathematics, $\langle$\href{https://hal.archives-ouvertes.fr/hal-03428570v1}{hal-03428570}$\rangle$ (2021)}
...
\cvitem{\textbf{2.}}{R. Grande, K. M. Kurianski, G. Staffilani, \emph{On the nonlinear Dysthe equation}, Nonlinear Analysis 207, 112292 (2021)}
...
\cvitem{\textbf{3.}}{R. Grande, \emph{Continuum limit for discrete NLS with memory effect}, soumis (2020), \url{arxiv.org/abs/1910.05681}}
...
\cvitem{\textbf{4.}}{R. Grande, \emph{Space-time fractional Nonlinear Schr\"odinger equation}, SIAM J.$\!$ Math.$\!$ Anal (2019), 51(5), 4172-4212}
...
\cvitem{\textbf{5.}}{R. Grande,  \emph{The role of smoothing effect in some dispersive equations}, PhD thesis, Massachusetts Institute of Technology (2020)}

\cvitem{\textbf{6.}}{R. Grande, I. Kov\'acs, K. Kutnar, A. Malni\v{c}, L. Mart\'inez, D. Maru\v{s}i\v{c},  \emph{Equisizable partial sum families}, Journal of Algebraic Combinatorics 51, 273-296 (2020)}

\cvitem{\textbf{7.}}{M. Conder, R. Grande, \emph{On embeddings of circulant graphs}, Electronic Journal of Combinatorics 22 (2015), $\#$ P2.28}
...
\cvitem{Juin 2022}{\textbf{Mini-cours sur Grandes D\'eviations pour EDPs (4h)}, SISSA Trieste}
...
\cvitem{Mai 2022}{\textbf{Oberwolfach Workshop}, Deterministic Dynamics and Randomness in PDE}
